            ...
            <Col sm={10}>
              <Accordion flush>
                <Accordion.Item eventKey="0">
                  <Accordion.Header>
                    <h6 className=" py-2">
                      Can i disconnect my children's devices from the Internet
                      in case they spent too much time online ?
                    </h6>
                  </Accordion.Header>
                  <Accordion.Body className="text-muted my-3">
                    Yes, you can. Just open the parent app (Surfie-Parent) and
                    tab the disconnect button on the bottom of the Family
                    Overview screen. If you want to disconnect just some of your
                    children, then select the disconnect button on the relevant
                    profiles.
                  </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="1">
                  <Accordion.Header>
                    <h6 className=" py-2">
                      I installed the child-app on my children's iphones but i
                      do not see any information on what application they used?
                    </h6>
                  </Accordion.Header>
                  <Accordion.Body className="text-muted my-3">
                    ...
                    will also introduce app-usage tracking for iOS devices (as
                    we already have for Android phones and tablets).
                  </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="2">
                  <Accordion.Header>
                    <h6 className="py-2">
                      ...
                      connection error "Your certeficate is permature" what
                      shouid i do?
                    </h6>
                  </Accordion.Header>
                  <Accordion.Body className="text-muted my-3">
                ...
                <Accordion.Item eventKey="3">
                  ...
                  <Accordion.Body className="text-muted my-3">
                    Tab the "Forgot Password" option on the sign in screen of
                    the parent app. An email will be sent to you to reset your
                    password.
                  </Accordion.Body>
                </Accordion.Item>
                ...
                <Accordion.Item eventKey="7">
                  ...
                  <Accordion.Body className="text-muted my-3">
                    <ul>
                      <li>
                        1. On the parent app, tab Settings on the Family
                        Overview screen
                      </li>
                ...
                <Accordion.Item eventKey="8">
                  <Accordion.Header>
                    <h6 className="py-2">
                      I installed the parental application on my android phone,
                      i then created a profile for my daughter and sent the
                      download link of the child-app to her phone. Later day i
                      checked her online activities but i only saw three empty
                      screen: Social, Web, and Time. Why and where is the
                      Location and App screen?
                    </h6>
                  </Accordion.Header>
                  <Accordion.Body className="text-muted my-3">
                    You did not complete the installation of the child-app on
                    your daughter’s phone. Take her phone and click on the
                    installation link you sent. Complete the installation and
                    you will see also the location and app screen. After your
                    daughter uses her phone, you will see some of her online
                    activities.
                  </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="9">
                  ...
                  <Accordion.Body className="text-muted my-3">
                    ...
                    Facebook App on your son’s Android device or iPhone and
                    follow the install wizard. Once you have activated our
                    Facebook protection on one platform (Android, iOS or
                    Windows) it will work for all of them.
                  </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="10">
                  <Accordion.Header>
                    <h6 className=" py-2">
                      I subscribed from your service, How do i delete my
                      account?
                    </h6>
                  </Accordion.Header>
                  <Accordion.Body className="text-muted my-3">
                ...
                <Accordion.Item eventKey="11">
                  ...
                  <Accordion.Body className="text-muted my-3">
                    <ul>
                      <li>
                        Purchase was made via surifieethiopia.com website:{" "}
                      </li>
                      <li>
                        Contact us at: support@surfieethiopia.com with your
                        order number{" "}
                      </li>
                      ...
                      <li>
                        ...
                        tap “iTunes & App Store” instead. Then type in your
                        Apple ID, tap View Apple ID, sign in, scroll down to
                ...
                <Accordion.Item eventKey="12">
                  ...
                  <Accordion.Body className="text-muted my-3">
                    ...
                    the “Connect button” on the top of daughter’s profile.
                    Within a few seconds the device will be reconnected to the
                    Internet.
                  </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="13">
                  <Accordion.Header>
                    <h6 className="py-2">
                      I used the option to disconnect the computer of son from
                      the internet. Now i want to reconnect him, but it does't
                ...
                <Accordion.Item eventKey="14">
                  <Accordion.Header>
                    <h6 className=" py-2">
                      I do not see my daughter's location anymore and i don't
                      get notification when she leaves school. what can i do?
                    </h6>
                  </Accordion.Header>
                  <Accordion.Body className="text-muted my-3">
                    <ul>
                      ...
                      <li>
                        ...
                        settings. Secondly, you need to check if Surfie-Kids
                        still has the required location permissions. Go to
                        Settings, Manage Apps, look for Surfie-Kids, go to
                        permissions and make sure that the location permission
                        is turned on and set to “always allow” (Note, the terms
                        used by each phone manufacturer might be slightly
              ...
              <Row className="d-flex justify-content-evenly align-content-center ">
                ...
                {info.positive ? (
                  ...
                  <Col className="m-auto bg-danger bg-opacity-10 p-1  text-center rounded-1 d-flex justify-content-evenly align-content-center me-3">
                    ...
                    />
                    <p className="text-danger m-auto">{info.prompt} </p>
