    ...
    >
      ...
      <>
        <Row className="mt-3 d-flex pb-4 ">
          <Col sm={2}>
            <div
              className=" mt-3 mb-2  d-flex justify-content-center align-items-center rounded-circle faq shadow  m-auto "
              ...
              <Accordion flush>
                ...
                >
                  ...
                  >
                    <p className=" py-2 text-secondary ">
                      {t(
                        "Can i disconnect my children's devices from the Internet in case they spent too much time online?"
                      )}
                    </p>
                  </Accordion.Header>
                  <Accordion.Body className="text-muted my-3">
                    {t(
                      "Yes, you can. Just open the parent app (Surfie-Parent) and tab the disconnect button on the bottom of the Family Overview screen. If you want to disconnect just some of your children, then select the disconnect button on the relevant profiles."
                    )}
                  </Accordion.Body>
                </Accordion.Item>
                ...
                >
                  <Accordion.Header>
                    <p className=" py-2 text-secondary ">
                      {t(
                        "I installed the child-app on my childrens iphones but i do not see any information on what application they used?"
                      )}
                    </p>
                  </Accordion.Header>
                  <Accordion.Body className="text-muted my-3">
                ...
                >
                  <Accordion.Header>
                    <p className=" py-2 text-secondary ">
                      {t(
                        "During the Surfie-Kid app installation, I got a VPN connection error 'Your certeficate is permature' what shouid i do?"
                      )}
                    </p>
                  </Accordion.Header>
                  <Accordion.Body className="text-muted my-3">
                ...
                >
                  <Accordion.Header>
                    <p className=" py-2 text-secondary ">
                      {t(
                        "I have Surfie installed on my son device and i want to give this device to my daughter now. How can i change the profile?"
                      )}
                    </p>
                  </Accordion.Header>
                  <Accordion.Body className="text-muted my-3">
                    {t(
                      "Login to our parent web-portal at: http://surfie.puresight.com. We recommend to use a PC for that. Select Settings, Advanced Setting and finally Device settings. Look for your son’s device and select your daughter’s profile from the drop-down list. Click Save Changes."
                    )}
                  </Accordion.Body>
                </Accordion.Item>
                ...
                >
                  ...
                  <Accordion.Body className="text-muted my-3">
                    <ul>
                      ...
                      <li>
                        {t(
                          "6. Under Step 3, enter the relevant site (example:cnn.com; disney.com)"
                        )}
                      </li>
                ...
                <Accordion.Item eventKey="10">
                  <Accordion.Header>
                    <p className=" py-2 text-secondary ">
                      {t(
                        "I subscribed to your service, How do i delete my account?"
                      )}
                    </p>
                  </Accordion.Header>
                  <Accordion.Body className="text-muted my-3">
                ...
                <Accordion.Item eventKey="12">
                  <Accordion.Header>
                    <p className=" py-2 text-secondary ">
                      {t(
                        "My daughter's profile is gray and it says 'You turned her device off'. How do i turn it on again?"
                      )}
                    </p>
                  </Accordion.Header>
                  <Accordion.Body className="text-muted my-3">
                ...
                <Accordion.Item eventKey="13">
                  <Accordion.Header>
                    <p className=" py-2 text-secondary ">
                      {t(
                        "I used the option to disconnect the computer of my son from the internet. Now i want to reconnect him, but it does't seem to work. what can i do?"
                      )}
                    </p>
                  </Accordion.Header>
                  <Accordion.Body className="text-muted my-3">
        ...
        <Row className=" pt-3 d-flex pb-5 ">
          <Col sm={2}>
            <div
              className=" mb-3 d-flex justify-content-center align-items-center rounded-circle faq shadow m-auto "
              style={{ color: "var(--bg-color)" }}
            >
          ...
          <Col sm={4} className="text-white p-5 ">
            <Card className="rounded-3 primary-fill">
              <Card.Body className=" py-4">
                ...
                <p
                  className="ps-3 pe-3 pt-0 just  fs-6"
                  style={{ color: "var(--bg-color)" }}
                >
                ...
                <Card.Text className=" pt-3">
                  <Row className="ps-3 d-flex justify-content-between align-items-center">
                    ...
                    <Col sm={9} className="mt-2">
                      <span
                        className=" fs-5 fw-semibold pe-3 "
                        style={{ color: "var(--bg-color)" }}
                      >
                        {t("Visit Us")}
                      </span>
                      <p
                        className=" fs-6 pe-3 small"
                        style={{ color: "var(--bg-color)" }}
                      >
                        {t(
