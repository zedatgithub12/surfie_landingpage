    ...
    <div>
      <Container>
        ...
        <Row className="d-flex p-4 mt-3">
          <p className="text-left pt-3 fs-2 fw-semibold">
            {" "}
            {t("Surfie Ethiopia App Features")}{" "}
          </p>
        </Row>
        ...
        <Row>
          <Col id="card">
            <Card
              className="border-0 shadow-sm m-2 mb-4 p-2 primary"
              style={{
            ...
            <Card
              className="border-0 shadow-sm m-2 mb-4 p-2 "
              style={{
                backgroundColor: "var(--sec-bg)",
                color: "var(--text-color)",
              }}
            >
              <Card.Body>
                ...
                <Card.Title className="primary-text mt-2">
                  {t("Cross Devices Protection")}
                </Card.Title>
                <Card.Text className="text-muted fw-lighter mt-3">
                  {t(
            ...
            >
              <Card.Body>
                ...
                <Card.Text className="text-muted fw-lighter mt-3">
                  {t(
                    "Location tracking features to help parents keep tabs on their childrens whereabouts."
                  )}
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col id="card">
              ...
              <Card.Body>
                <div className="d-flex justify-content-end position-absolute end-0 bottom-0 m-2 ">
                  <span className="align-items-center rounded-circle">
                    <MdWebAssetOff
                      size={42}
                      className="secondary-color m-2 mt-3"
                    />
                  </span>
                </div>
                <Card.Title className="primary-text mt-2">
            ...
            >
              <Card.Body>
                ...
                <Card.Title className="primary-text mt-2">
                  {t("App and game blocking")}
                </Card.Title>
                <Card.Text className="text-muted fw-lighter mt-3">
                  {t(
                    "Allows parents to block access to certain apps on their childrens devices. Parents can choose which apps they want to block based on their content, age rating, or other criteria."
                  )}
                </Card.Text>
              </Card.Body>
            </Card>
            ...
            <Link
              className="btn btn-md btn-light  px-3 ms-2 mb-5 p-2 fs-6 fw-semibold shadow-sm "
              id="find"
              to="/features"
              style={{
                backgroundColor: "var(--sec-bg)",
      ...
      <Container>
        ...
        <Row className=" mb-3 p-4 rounded-4 gradient blur">
          <Col lg={6} className="mt-3 mb-3 ms-3">
            <p className="text-left fs-2 " style={{ color: "var(--sec-bg)" }}>
              {" "}
