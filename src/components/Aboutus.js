    ...
    <>
      <Container>
        <Row className="py-3">
          ...
          <Col sm={2}>
            ...
            >
              <AiOutlineProfile size={70} className="primary-text m-auto" />
            </div>
          </Col>
          <Col sm={6} className=" ps-4">
            <p className="p-2 mt-4 fs-2"> {t("About Us")} </p>
      ...
      <Container fluid className="gradient">
        <Row className="d-flex  justify-content-center">
          ...
          <Col
            sm={4}
            className=" border-start border-secondary p-3 px-4 mb-3 m-3 h-100"
          >
