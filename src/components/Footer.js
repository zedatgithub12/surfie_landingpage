  ...
  return (
    <Container fluid>
      <Row className="fot text-white  pt-3">
        <p
          className="fs-4 text-center text-dark mt-2"
        ...
        <Col sm={4} className="pb-4">
          <form>
            <FormControl>
              ...
              />
              {data.status === "exist" && (
                <FormHelperText className="fs-6 fw-normal text-dark">
                  <AiFillWarning size={28} className="text-danger mx-2" />
                  {t(
                    "We have already sent you an email check your inbox or spam folder!"
                  )}
                </FormHelperText>
              )}
              {data.status === "failure" && (
                ...
                >
                  <BiErrorCircle size={22} className="text-danger mx-2" />
                  {t("Oops! something went wrong")}
                </FormHelperText>
              )}

              {data.status === "sent" && (
                <FormHelperText className="text-success fw-semibold">
      ...
      <Row className="primary-fill pt-4 ps-3  pb-4">
        ...
        >
          ...
          <ul className="list-unstyled text-small mt-1 d-flex ">
            ...
            <li className="m-2">
              <NavLink
                to="https://twitter.com/Surfie_ethiopia"
                target="_blank"
                className="nav-link "
              >
            ...
            <li className="m-2">
              <NavLink
                to="https://www.youtube.com/@SurfieEthiopia"
                target="_blank"
                className="nav-link "
              >
        ...
        >
          ...
          <ul
            className="list-unstyled text-small mt-1"
            style={{ color: "var(--sec-bg)" }}
          >
            <li className="mb-1">
            ...
            <li className="mb-1">
              <NavLink to="/pricing" className=" text-decoration-none nav-link">
                {t("Pricing")}
              </NavLink>
            </li>
            <li className="mb-1">
              <NavLink to="/about" className=" text-decoration-none nav-link">
                {t("About Us")}
              </NavLink>
            </li>
            <li className="mb-1">
            ...
            <li className="mb-1">
              <NavLink to="/account" className=" text-decoration-none nav-link">
                {t("Get started")}
              </NavLink>
            </li>
          </ul>
        ...
        <Col sm={4} className="align-items-center">
          ...
          <ul
            className="list-unstyled text-small mt-1 fw-normal"
            style={{ color: "var(--sec-bg)" }}
          >
